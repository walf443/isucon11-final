...
use isucholar_core::services::unread_announcement_service::{
    UnreadAnnouncementService, UnreadAnnouncementServiceImpl,
};
...
pub async fn get_announcement_detail(
    ...
    let unread_announcement_service = UnreadAnnouncementServiceImpl::new();
    let result = unread_announcement_service
